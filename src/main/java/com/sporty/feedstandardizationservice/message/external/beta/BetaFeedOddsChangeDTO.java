...
public record BetaFeedOddsChangeDTO(
        ...
        implements BetaFeedDTO, OddsChangeDTO {
    private static final Logger LOGGER = LoggerFactory.getLogger(BetaFeedOddsChangeDTO.class);
