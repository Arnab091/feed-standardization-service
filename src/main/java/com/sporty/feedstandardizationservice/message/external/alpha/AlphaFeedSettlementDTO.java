...
public record AlphaFeedSettlementDTO(
        ...
        implements AlphaFeedDTO, SettlementDTO {
    private static final Logger LOGGER = LoggerFactory.getLogger(AlphaFeedSettlementDTO.class);
