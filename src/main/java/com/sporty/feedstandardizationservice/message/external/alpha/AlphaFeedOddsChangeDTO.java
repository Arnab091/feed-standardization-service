...
public record AlphaFeedOddsChangeDTO(
        ...
        implements AlphaFeedDTO, OddsChangeDTO {
    private static final Logger LOGGER = LoggerFactory.getLogger(AlphaFeedOddsChangeDTO.class);
    ...
    public OddsChangeMessage toOddsChangeMessage() {
        ...
        return new OddsChangeMessage(eventId, odds.home(), odds.draw(), odds.away());
    }
}
